...
// include: C:/code1100/msys64/tmp/tmpgg_djb22.js
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    loadPackage({"files": [{"filename": "/brickgame-cli.exe", "start": 0, "end": 18432}, {"filename": "/highscore.tetris", "start": 18432, "end": 18432}], "remote_package_size": 18432});

  })();

// end include: C:/code1100/msys64/tmp/tmpgg_djb22.js
// include: C:/code1100/msys64/tmp/tmp4xoykn6e.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:/code1100/msys64/tmp/tmp4xoykn6e.js
// include: C:/code1100/msys64/tmp/tmpdtrax6es.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:/code1100/msys64/tmp/tmpdtrax6es.js
...
// Begin JS library code
  ...
  allocateUnusedWorker() {
        ...
        worker = new Worker(new URL('tetris.js', import.meta.url), {
          'type': 'module',
          // This is the way that we signal to the node worker that it is hosting
          // a pthread.
          'workerData': 'em-pthread',
...
var _userInput = Module['_userInput'] = makeInvalidEarlyAccess('_userInput');
var _updateCurrentState = Module['_updateCurrentState'] = makeInvalidEarlyAccess('_updateCurrentState');
...
function assignWasmExports(wasmExports) {
  Module['_userInput'] = _userInput = createExportWrapper('userInput', 2);
  Module['_updateCurrentState'] = _updateCurrentState = createExportWrapper('updateCurrentState', 1);
